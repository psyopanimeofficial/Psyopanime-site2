    ...
    <>
      ...
      <header className="absolute top-0 left-0 right-0 z-40 px-4 md:px-8 py-4 md:py-6 flex items-start justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 md:gap-2 px-2.5 md:px-4 py-1.5 md:py-2 border border-white/30 rounded-lg bg-black/30 backdrop-blur-sm hover:bg-white/10 transition-all group flex-shrink-0"
        >
            <span className="text-[10px] md:text-sm font-mono tracking-wider text-green-400 font-bold">
              AUDIO {isMuted ? 'OFF' : 'ON'}
            </span>
            <svg 
              className="w-3.5 h-3.5 md:w-5 md:h-5 text-white/70 group-hover:text-white transition-colors" 
              fill="none" 
              viewBox="0 0 24 24" 
              stroke="currentColor"
            >
