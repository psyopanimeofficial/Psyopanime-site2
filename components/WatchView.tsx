...
const WatchView: React.FC<WatchViewProps> = ({ onBack }) => {
  ...
  // Standard embed URL - NO autoplay, NO mute
  const embedUrl = `https://www.youtube.com/embed/${currentVideo.id}?rel=0&controls=1&playsinline=1`;
  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col bg-black/95 text-white overflow-hidden font-mono">
      ...
      {/* Header Bar */}
      <div className="flex justify-between items-center p-3 md:p-6 border-b border-white/10 bg-black/50 backdrop-blur-md z-40 shrink-0">
